 ...
 *
 * <p>
 * {@link #verifiedUnique} is set by {@code extract.IdentityResolver} when the
 * agent has confirmed, against the live component tree, that this locator
 * resolves to exactly one component. Replay must prefer verified-unique
 * locators; a locator that is not verified-unique may silently match the wrong
 * widget (e.g. the first of many "Order Number" cells in a grid).
 *
 * <p>
