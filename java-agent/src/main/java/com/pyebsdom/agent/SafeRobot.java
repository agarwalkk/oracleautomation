    ...
    private void typeChar(char ch) {
        if (ch >= 'a' && ch <= 'z') {
            ...
            if (codes != null) {
                ...
                System.err.println("[SafeRobot] unsupported char: '" + ch
